...
function Navbar() {
  ...
  return (
    <AppBar 
      position="static" 
      sx={{ 
        bgcolor: "#1a237e",  // ✅ اللون الأزرق
        boxShadow: "0 2px 8px rgba(0,0,0,0.15)" 
      }}
    >
      <Toolbar sx={{ justifyContent: "space-between" }}>
        {/* ✅ تم إزالة TestFlyQA - Quality Assurance Platform */}
        
        {/* Right side: User info, notifications, language, logout */}
        {user && (
          <Box display="flex" alignItems="center" gap={isMobile ? 1 : 2} sx={{ ml: "auto" }}>
            <LanguageSwitcher />
            <Notifications />
            {!isMobile && (
