        ...
        if (!context.ProcurementRequests.Any())
        {
            context.ProcurementRequests.AddRange(
                new ProcurementRequest
                {
                    ...
                    Department = "QA",
                    Requester = "Kinoura Youssef",
                    Vendor = "Sonda",
                    Items = "Office supplies (paper, pens, folders)",
                    TotalAmount = 250.00m,
                    Status = "Approved",
                    Priority = "Medium",
                    RequestDate = new DateTime(2026, 8, 10),
                ...
                new ProcurementRequest
                {
                    ...
                    Items = "5 laptops, 3 monitors",
                    TotalAmount = 15000.00m,
                    Status = "Pending",
                    Priority = "High",
                    RequestDate = new DateTime(2026, 8, 5),
                    CreatedAt = DateTime.UtcNow
                },
                new ProcurementRequest
                {
                    ...
                    Requester = "Sara Ali",
                    Vendor = "Kalunga",
                    Items = "Training materials",
                    TotalAmount = 500.00m,
                    Status = "Approved",
                    Priority = "Low",
                    RequestDate = new DateTime(2026, 8, 1),
                    ApprovedBy = "Admin User",
                    CreatedAt = DateTime.UtcNow
                }
            );
